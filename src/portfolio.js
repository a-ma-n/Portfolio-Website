...
const projectsHeader = {
  title: "Projects",
  description:
    "My projects make use of vast variety of latest technology tools. My best experience is to create projects with React and deploy them to web applications using cloud infrastructure.",
